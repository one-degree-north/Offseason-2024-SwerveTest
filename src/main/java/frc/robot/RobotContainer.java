...
public class RobotContainer {
  ...
  private void configureBindings() {
    ...
    mainController.cross().whileTrue(drivetrain.applyRequest(() -> brake));
    mainController.circle().whileTrue(drivetrain
        .applyRequest(() -> point.withModuleDirection(new Rotation2d(-mainController.getLeftY(), -mainController.getLeftX()))));
